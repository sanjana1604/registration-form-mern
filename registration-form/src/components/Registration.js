...
const Registration= () =>{
  ...
  const onSubmit=async(e)=>{
    ...
    if(isValid){
      ...
      const fatherName1=fatherName;
      const schoolName1=schoolName;
      const course1=course;
      const specialization1=specialization;
      // const gender1=gender;
      // const dob1=dob;
      // const createdDate1= createdDate;
      ...
      const res=await fetch("/student",{
        ...
        //stringify is for sending he json data into string format to server.
        body:JSON.stringify({
          rollNo:rollNo1,uname:uname1,email:email1,password:password1,fatherName: fatherName1,schoolName: schoolName1,course: course1,specialization: specialization1,mobileNo: mobileNo1      
        })
      });
      ...
      // const {rollNo, uname, email, mobileNo, fatherName, schoolName, course, specialization, dob, createdDate, gender}=
      //SEND TO BACKEND
